...
Phase III — Device Integration: The assembly of small-sized SOFCs and SOECs marks the transition from material evaluation to device validation. These prototype cells serve as platforms for electrochemical benchmarking and degradation studies. In parallel, optimization of the QUATI beamline configuration for in-situ and operando studies is initiated. Initial in-situ experiments validate experimental geometry, signal-to-noise ratios, and operability under realistic redox and reforming environments.
...
\begin{ganttchart}[
   ...
   vrule/.style={dashed,teal},%BrickRed
    ...
    \ganttbar{{\small  \color{black!60}  10- Optimization of QUATI Beamline for In-Situ/Operando Studies}}{2025-04-01}{2025-04-01}\\
    % ---- Cell Construction ----
    \ganttbar{{\small  \color{black!60} 11- Construction of Reaction Cells for In-Situ/Operando Experiments on QUATI Beamline}}{2025-03-01}{2025-04-01}\\
    % ---- Initial Operando ----
